function renderHistogram(id, data) {
	...
	var x = d3.scaleLinear()
			.domain([0, d3.max(data.labels, function (d) {return d;})])
			.range([0, width])
	...
	svg.append('g')
        ...
        .call(d3.axisLeft(y).tickValues(d3.range(0, maxValue + step, step))); //利用axis函数来设置ticks，如axis.tickValues([values]),使用固定范围的ticks
}
